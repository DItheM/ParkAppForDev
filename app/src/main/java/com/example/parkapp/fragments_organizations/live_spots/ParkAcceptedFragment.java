...
public class ParkAcceptedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_park_accepted, container, false);
        ...
        if (DatabaseHelper.userId() != null) {
            mDatabase.child("Organizations").child("data").child(DatabaseHelper.userId()).child("park").child("accepted").addValueEventListener(new ValueEventListener() {
                @Override
        ...
        adapter = new RecycleViewAdapterParkRequests(getContext(), list, 1);
