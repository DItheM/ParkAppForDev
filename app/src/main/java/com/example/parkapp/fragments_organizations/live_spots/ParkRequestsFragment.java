...
import com.example.parkapp.fragments_owners.ViewRequestsActivity;
...
public class ParkRequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_park_requests, container, false);
        ...
        if (DatabaseHelper.userId() != null) {
            mDatabase.child("Organizations").child("data").child(DatabaseHelper.userId()).child("park").child("requests").addValueEventListener(new ValueEventListener() {
                @Override
        ...
        adapter = new RecycleViewAdapterParkRequests(getContext(), list, 0);
